...
class _ResolvableAssetAttributesModel(BaseModel):
    deps: Sequence[str] = []
...
class AssetAttributesModel(_ResolvableAssetAttributesModel, ResolvableModel[Mapping[str, Any]]):
...
class AssetSpecModel(_ResolvableAssetAttributesModel, ResolvableModel[AssetSpec]):
    key: str
